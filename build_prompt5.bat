...
echo [1/4] Compiling Prompt 5 Backup, Restore & Data Recovery Android APK...
...
echo [SUCCESS] Prompt 5 Backup, Restore & Data Recovery System is live on your mobile device!
